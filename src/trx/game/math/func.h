...
DIRECTION_8 Math_GetDirection8(int16_t angle);
DIRECTION Math_GetDirectionCone(int16_t angle, int16_t cone);
DIRECTION_8 Math_GetDirectionCone8(int16_t angle, int16_t cone);
int16_t Math_DirectionToAngle(DIRECTION dir);
int16_t Math_Direction8ToAngle(DIRECTION_8 dir);
